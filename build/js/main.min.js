...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var headerButtonText = document.querySelector('.header__text');
  ...
  var _loop = function _loop(i) {
    telephones[i].addEventListener('input', function () {
      var value = telephones[i].value.replace(/\D+/g, '');
      var numberLength = 11;
      var result;
      ...
      //
      for (var j = 0; j < value.length && j < numberLength; j++) {
        switch (j) {
          case 0:
  ...
  var formCheckbox = form.querySelector('#checkbox');
  var formLabel = form.querySelector('#label-checkbox');
